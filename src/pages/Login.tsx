...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 bg-background transition-colors duration-300">
      {/* Background Elements */}
      ...
      >
        <div className="bg-card border border-border rounded-[2.5rem] p-8 md:p-12 shadow-2xl backdrop-blur-xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-foreground tracking-tight">{userLogin.loginTitle}</h2>
            ...
            {!showPhoneOtp ? (
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-2">Verify Identity</h3>
