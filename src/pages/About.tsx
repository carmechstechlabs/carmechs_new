...
import { CheckCircle2, Users, Award, History, ArrowRight, ShieldCheck, Zap, Globe, Terminal, Activity } from "lucide-react";
...
export function About() {
  return (
    <div className="bg-white min-h-screen">
      {/* Hero */}
      <section className="bg-slate-50 pt-40 pb-32 relative overflow-hidden border-b border-slate-100">
      ...
      <section className="py-32 bg-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter leading-none">Our Principles</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/30 mb-6">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-primary">System Specs</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">Precision <br /> Infrastructure</h2>
              <p className="text-xl text-white/60 font-medium mb-12 leading-relaxed">
                Our workshops are more than just garages. They are high-tech diagnostic centers equipped with proprietary software and industrial-grade hardware.
              </p>
              
              <div className="space-y-6">
                {[
                  { label: "Diagnostic Latency", value: "< 50ms" },
                  { label: "Data Points per Scan", value: "1,200+" },
                  { label: "Component Verification", value: "Blockchain-Backed" },
                  { label: "Operational Uptime", value: "99.9%" }
                ].map((spec, i) => (
                  <div key={i} className="flex items-center justify-between py-4 border-b border-white/10">
                    <span className="text-xs font-black uppercase tracking-widest text-white/40">{spec.label}</span>
                    <span className="text-lg font-black text-primary font-mono">{spec.value}</span>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-square rounded-[4rem] overflow-hidden border border-white/10 relative group">
                ...
                {/* Overlay UI Elements */}
                <div className="absolute top-10 left-10 p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl">
                  <Activity className="h-8 w-8 text-primary mb-4" />
                  <div className="text-2xl font-black font-mono">LIVE_FEED</div>
                  <div className="text-[10px] font-black uppercase tracking-widest text-white/40">Diagnostic Active</div>
                </div>
              </div>
              
              {/* Decorative Glow */}
              <div className="absolute -inset-20 bg-primary/20 blur-[120px] -z-10" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-slate-50 rounded-[4rem] p-12 md:p-24 flex flex-col lg:flex-row items-center gap-16 border border-slate-100 shadow-xl shadow-slate-200/50">
            ...
            <div className="flex-1 grid grid-cols-2 gap-4">
              <img src="https://images.unsplash.com/photo-1517524206127-48bbd363f3d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" className="rounded-[2rem] h-64 w-full object-cover shadow-lg" alt="" />
              <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" className="rounded-[2rem] h-64 w-full object-cover mt-12 shadow-lg" alt="" />
            </div>
          </div>
        </div>
      </section>
