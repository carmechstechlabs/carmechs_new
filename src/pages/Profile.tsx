                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                          ...
                          <div className="flex flex-row md:flex-col items-center md:items-end justify-between gap-4">
                            ...
                            <Button 
                              ...
                              className="text-primary hover:bg-primary/5 hover:text-primary rounded-xl group-hover:translate-x-2 transition-all"
                            >
            ...
            >
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 max-h-[70vh] overflow-y-auto scrollbar-none">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[11px] font-black text-primary uppercase tracking-tight">
                          {getServiceTitle(selectedAppointment.service)}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2">
                      <Hash className="h-3 w-3 text-primary" /> Billing & Payment
                    </h4>
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                      <div className="flex items-center justify-between">
                  ...
                  {selectedAppointment.issuePhotos && selectedAppointment.issuePhotos.length > 0 && (
                    <div className="space-y-4">
                      <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2">
                        <Zap className="h-3 w-3 text-primary" /> Visual Diagnostics
                      </h4>
                      <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <div className="grid grid-cols-2 gap-2">
                          {selectedAppointment.issuePhotos.map((photo: string, idx: number) => (
              ...
              <div className="p-8 bg-slate-50/50 border-t border-slate-100">
                <Button 
                  className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-black uppercase tracking-widest rounded-xl shadow-lg shadow-primary/20" 
