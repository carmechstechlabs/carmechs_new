...
-- Navigation Items
INSERT INTO navigation_items (id, label, path, "order", is_active, is_external) VALUES
    ('1', 'Home', '/', 1, true, false),
    ('2', 'Services', '/services', 2, true, false),
    ('3', 'Brands', '/#brands', 3, true, false),
    ('4', 'Locations', '/#locations', 4, true, false),
    ('5', 'About', '/about', 5, true, false),
    ('6', 'Contact', '/contact', 6, true, false)
ON CONFLICT (id) DO NOTHING;
